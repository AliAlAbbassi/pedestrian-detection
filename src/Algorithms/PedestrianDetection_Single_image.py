...
def initialize_pedestrian_detection_single_image(image_path):
    ...
    pedestrians = np.array([[x, y, x + w, y + h]
    ...
    cv2.putText(frame, f'Total Persons : {count}', (10, 20),
            cv2.FONT_HERSHEY_DUPLEX, 0.8, (255, 0, 0), 1)
